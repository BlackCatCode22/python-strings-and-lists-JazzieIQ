...
print(
    "Welcome to Mac Mac's Python Strings and Lists Program.\n\n"
...
def script():
    ...
    print(
        "Let's begin.\n\nThe above phrase has an index length of "
        + str(text_length)
        + "\n"
    )
    start = int(
        input("To begin the program enter an index number to create a substring: ")
    )
    ...
    print(
        '"I like it as you like it." Your word replacement is '
        + '"'
        + replacement
        + '".\n'
    )
    user_char = input(
        "Now please choose a single letter or a single character or a string of letters or characters "
        "from the phrase: "
    )
    ...
    restart = input(
        "That was fun! let's go again. Would you like to change your inputs? "
    ).upper()
    if restart == "YES" or restart == "Y":
        ...
        if correct_restart == "y":
            ...
            print(
                "Thank you for testing Mac Mac's string's and lists program. Goodbye."
            )
    else:
        print('I understand you said "' + restart + '"\n')
